...
print('Num {}, Node {} {} {}, Edge {} {} {}'.format(
    ...
    min(node_nums),
    max(node_nums),
    sum(node_nums) / len(node_nums),
    min(edge_nums), max(edge_nums),
    sum(edge_nums) / len(edge_nums)))

dataset_train = Dataset_sat(graphs_train, nodes_par1s_train, nodes_par2s_train, epoch_len=5000,
                            yield_prob=args.yield_prob, speedup=True)
dataset_test = Dataset_sat(graphs_train, nodes_par1s_train, nodes_par2s_train, epoch_len=1000,
